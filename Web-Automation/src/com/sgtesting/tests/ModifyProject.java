...
public class ModifyProject {
	...
	static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(3000);
			oBrowser.findElement(By.xpath("//*[@id=\'customerLightBox_nameField']")).sendKeys("Arshi");
			Thread.sleep(3000);
	...
	static void createProject()
	{
		try
		{
			...
			Thread.sleep(3000);
			oBrowser.findElement(By.xpath("//*[@id='projectPopup_projectNameField']")).sendKeys("Web Automation");
			Thread.sleep(3000);
	...
	static void deleteCustomer()
	{
		try
		{
			...
			Thread.sleep(3000);
			oBrowser.findElement(By.xpath("//*[@id=\'customerPanel_deleteConfirm_submitTitle\']/div")).click();
			Thread.sleep(3000);
		}catch(Exception e)
		{
			e.printStackTrace();
